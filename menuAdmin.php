      ...
      <section class="sectionMenu">
        <div class="containerfluid font-weight-bold">
          ...
          <div class="containerfluid">
                <form method="post" action="agregar" class="form-inline">
                    <div class="form-group w-25 p-3 ml-5">
                        <label for="">Nombre</label>
                        <input type="text" class="form-control" id="Nombre" name="Nombre"  placeholder="Ingrese Nombre">
                    </div>
                    <div class="form-group w-25 p-3 ml-3">
                    ...
                    <button type="submit" class="btn btn-outline-danger btn-md">Agregar</button>
                </form>
          </div>
